...
tape( 'if provided `+infinity` for `x` and a valid `lambda`, the function returns `0`', opts, function test( t ) {
	var y = logcdf( PINF, 0.5 );
	t.equal( y, 0.0, 'returns expected value' );
	t.end();
});

tape( 'if provided a negative number for `x` and a valid `lambda`, the function returns `-Infinity`', opts, function test( t ) {
...
tape( 'if provided a value shape parameter `lambda` which nonpositive, the function returns `NaN`', opts, function test( t ) {
	var y;
